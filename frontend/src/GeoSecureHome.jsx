        ...
        <main className="flex flex-1 items-center px-6 lg:px-16">
          <div className="max-w-xl py-12 lg:py-0">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-5">
              ...
              <button className="group flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-slate-700 dark:text-[#e8f1f2] transition-colors hover:text-teal-600 dark:hover:text-[#4ff0d7]">
                View live map
